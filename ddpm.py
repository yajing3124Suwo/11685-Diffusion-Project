...
class DDPMPipeline:
    ...
    def __call__(
        ...
        if classes is not None:
            ...
            class_embeds = self.class_embedder(classes) # TODO
            # TODO: get uncon class embeddings
            uncond_embeds = self.class_embedder(uncond_classes) # TODO
        
        # TODO: starts with random noise
        image = randn_tensor(image_shape, generator=generator, device=device) # TODO

        # TODO: set step values using set_timesteps of scheduler
        self.scheduler.set_timesteps(num_inference_steps, device=device) # TODO
