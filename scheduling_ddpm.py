...
class DDPMScheduler(nn.Module):
    ...
    def __init__(
        ...
        if self.beta_schedule == 'linear':
            ...
            betas = torch.linspace(beta_start, beta_end, num_train_timesteps, dtype=torch.float64) # TODO
        ...
        alphas_cumprod = torch.cumprod(alphas, dim=0) # TODO
        self.register_buffer("alphas_cumprod", alphas_cumprod)
        
        # TODO: timesteps
        timesteps = np.arange(0, num_train_timesteps)[::-1].copy() # TODO
    ...
    def set_timesteps(
        ...
        # TODO: set timesteps
        timesteps = np.arange(0, self.num_train_timesteps, self.num_train_timesteps // num_inference_steps)[::-1].copy() # TODO 
    ...
    def previous_timestep(self, timestep):
        ...
        prev_t = timestep - self.num_train_timesteps // num_inference_steps # TODO
        return prev_t
    ...
    def _get_variance(self, t):
        ...
        prev_t = self.previous_timestep(t) # TODO
        alpha_prod_t = self.alphas_cumprod[t] # TODO
        alpha_prod_t_prev = self.alphas_cumprod[prev_t] if prev_t >= 0 else torch.tensor(1.0) # TODO
        current_beta_t = 1 - alpha_prod_t / alpha_prod_t_prev # TODO
        ...
        variance = (1 - alpha_prod_t_prev) / (1 - alpha_prod_t) * current_beta_t # TODO 
    ...
    def add_noise(
        ...
        sqrt_alpha_prod = alphas_cumprod[timesteps] ** 0.5 # TODO
        sqrt_alpha_prod = sqrt_alpha_prod.flatten() # TODO
        while len(sqrt_alpha_prod.shape) < len(original_samples.shape):
            sqrt_alpha_prod = sqrt_alpha_prod.unsqueeze(-1)
            
        # TODO: get sqrt one miucs alphas
        sqrt_one_minus_alpha_prod = (1 - alphas_cumprod[timesteps]) ** 0.5 # TODO
        sqrt_one_minus_alpha_prod = sqrt_one_minus_alpha_prod.flatten() # TODO  
        ...
        noisy_samples = sqrt_alpha_prod * original_samples + sqrt_one_minus_alpha_prod * noise # TODO 
    ...
    def step(
        ...
        alpha_prod_t = self.alphas_cumprod[t]  # TODO
        alpha_prod_t_prev = self.alphas_cumprod[prev_t] if prev_t >= 0 else torch.tensor(1.0, device=sample.device)  # TODO
        beta_prod_t = 1 - alpha_prod_t  # TODO
        beta_prod_t_prev = 1 - alpha_prod_t_prev  # TODO
        current_alpha_t = alpha_prod_t / alpha_prod_t_prev  # TODO
        current_beta_t = 1 - current_alpha_t  # TODO
        ...
        pred_original_sample_coeff = (alpha_prod_t_prev ** 0.5 * current_beta_t) / beta_prod_t # TODO 
        current_sample_coeff = current_alpha_t ** 0.5 * beta_prod_t_prev / beta_prod_t # TODO 

        # 5. Compute predicted previous sample µ_t
        # See formula (7) from https://arxiv.org/pdf/2006.11239.pdf
        pred_prev_sample = pred_original_sample_coeff * pred_original_sample + current_sample_coeff * sample # TODO
